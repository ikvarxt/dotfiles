# Vendored from oh-my-zsh plugins/git/git.plugin.zsh. The two helpers below
# live in lib/git.zsh upstream; ~14 of the aliases need them.
...
# ---8<--- upstream oh-my-zsh git.plugin.zsh below this line ---8<---
